...
LOAD
DATA  LOCAL INFILE 'test_result_2021.csv'
...
LOAD
DATA LOCAL INFILE 'test_item_2021.csv'
INTO TABLE TESTITEM
FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
;
...
LOAD
DATA LOCAL INFILE 'item_detail.csv'
...
LOAD
DATA  LOCAL INFILE 'item_group.csv'
...
LOAD
DATA  LOCAL INFILE 'mdr_rfr_location.csv'
...
LOAD
DATA LOCAL  INFILE 'mdr_test_type.csv'
...
LOAD
DATA LOCAL INFILE 'mdr_fuel_types.csv'
...
LOAD
DATA LOCAL  INFILE 'mdr_test_outcome.csv'
